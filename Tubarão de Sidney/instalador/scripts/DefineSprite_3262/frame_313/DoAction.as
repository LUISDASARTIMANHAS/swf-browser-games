...
while(true)
{
   ...
   else
   {
      ...
      {
         set("\x01",eval("\x01") + 12);
         eval(§§constant(0))[§§constant(1)] = 0;
         eval(§§constant(0))[§§constant(2)][§§constant(3)](§§constant(2));
         break;
      }
      if(eval("\x01") == 512)
      {
                                 ...
                                 if(eval("\x01") == 551)
                                 {
                                    ...
                                    if(!§§pop())
                                    {
                                       if(eval("\x01") != 976)
                                       {
                                          ...
                                          if(eval(§§constant(5))[§§constant(6)](eval("{invalid_utf8:254}[{invalid_utf8:146}D")["{invalid_utf8:209}{invalid_utf8:253}\x0b"][")ߒJ"]["{invalid_utf8:162}Z\x06"][§§constant(4)]))
                                          {
                                             eval("{invalid_utf8:254}[{invalid_utf8:146}D")["{invalid_utf8:209}{invalid_utf8:253}\x0b"][")ߒJ"]["{invalid_utf8:162}Z\x06"][§§constant(7)][§§constant(8)][§§constant(9)][§§constant(10)]();
                                          }
                                          break loop0;
                                       }
                                       set("\x01",eval("\x01") - 43);
