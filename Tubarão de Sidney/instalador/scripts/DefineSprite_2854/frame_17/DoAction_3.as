      ...
      while(true)
      {
         ...
         else
         {
            if(eval("\x01") == 277)
            {
               ...
               eval("L{invalid_utf8:172}e")["gp{invalid_utf8:130}"]["{invalid_utf8:185}t{invalid_utf8:175}{invalid_utf8:197}"] += eval("t{invalid_utf8:204}{invalid_utf8:201}{invalid_utf8:183}");
               break loop0;
            }
            if(eval("\x01") == 380)
            {
   ...
   else
   {
      ...
      while(true)
      {
         ...
         })
         {
            ...
            set("\x01",eval("\x01") - 334);
            eval(§§pop())["˖"]["N{invalid_utf8:172}"] = eval("\x05{invalid_utf8:223}")["˖"]["N{invalid_utf8:172}"] + eval("{invalid_utf8:131}G");
            break loop0;
         }
         if(eval("\x01") == 291)
         {
