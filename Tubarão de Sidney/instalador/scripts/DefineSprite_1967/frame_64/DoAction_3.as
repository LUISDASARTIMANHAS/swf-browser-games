                        ...
                        else
                        {
                           ...
                           if(eval("\x01") != 984)
                           {
                              if(eval("\x01") == 529)
                              {
                                 ...
                                 _root.game._y.ingrid._y[§§constant(4)][§§constant(5)](1);
                                 _root.game._y.ingrid._y[§§constant(6)][§§constant(5)](1);
                                 _root.game._y.ingrid[§§constant(7)][§§constant(8)][§§constant(5)](1);
                                 _root[§§constant(9)] = 0;
                                 break loop0;
                              }
                              if(eval("\x01") == 41)
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     if(eval("\x01") == 220)
                     {
                        ...
                        if(eval("{invalid_utf8:140}EX")[§§constant(2)][§§constant(3)][§§constant(4)][§§constant(5)][§§constant(6)][§§constant(7)][§§constant(8)](eval("{invalid_utf8:140}EX")["\x16M"]))
                        {
                           eval("{invalid_utf8:140}EX")[§§constant(9)][§§constant(10)] = 1;
                           set(§§constant(11),eval(§§constant(11)) + 1);
                           eval("{invalid_utf8:140}EX")[§§constant(2)][§§constant(12)] += eval(§§constant(13));
                        }
                        break loop0;
                     }
                     if(eval("\x01") == 573)
                     ...
                     else
                     {
                        ...
                        else
                        {
                           if(eval("\x01") != 472)
                           {
                              ...
                              {
                                 set("\x01",eval("\x01") - 303);
                                 eval(":}{invalid_utf8:131}{invalid_utf8:160}")["I\f{invalid_utf8:180}"]["{invalid_utf8:219}{invalid_utf8:255}"] += eval("IY{invalid_utf8:149}{invalid_utf8:139}");
                                 break loop0;
                              }
                              if(eval("\x01") == 486)
                              {
         ...
         else
         {
            if(eval("\x01") != 178)
            {
               if(eval("\x01") == 81)
               {
                  ...
                  eval("{invalid_utf8:140}EX")["\x16M"][§§constant(2)] -= eval(§§constant(3));
                  eval("{invalid_utf8:140}EX")["\x16M"][§§constant(4)] -= eval(§§constant(3));
                  break;
               }
               if(eval("\x01") == 743)
               {
