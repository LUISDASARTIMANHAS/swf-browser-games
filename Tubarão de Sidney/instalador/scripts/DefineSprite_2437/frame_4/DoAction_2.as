         ...
         while(true)
         {
            ...
            else
            {
               ...
               if(eval("\x01") == 374)
               {
                  ...
                  eval("{invalid_utf8:255}Џ{invalid_utf8:226}")["{invalid_utf8:143}{invalid_utf8:136}{invalid_utf8:136}{invalid_utf8:130}"]["{invalid_utf8:255}{invalid_utf8:203}\x1c{invalid_utf8:171}"] += eval(§§constant(3));
                  break loop0;
               }
               if(eval("\x01") == 873)
               {
               ...
               else
               {
                  ...
                  else
                  {
                     ...
                     else if(eval("\x01") == 275)
                     {
                        set("\x01",eval("\x01") + 55);
                     }
                     else if(eval("\x01") == 627)
                     {
                     ...
                     else
                     {
                        if(eval("\x01") != 775)
                        {
                           if(eval("\x01") == 471)
                           {
                              ...
                              _root.board.score.z[§§constant(4)][§§constant(5)] -= 5;
                              break loop0;
                           }
                           break loop0;
                        }
         ...
         else
         {
            if(eval("\x01") != 845)
            {
               if(eval("\x01") == 246)
               {
                  ...
                  eval("{invalid_utf8:202}\\\x1c")["s{invalid_utf8:145}\r"][§§constant(2)] += eval(§§constant(3));
                  break loop0;
               }
               if(eval("\x01") == 680)
               {
                        ...
                        else
                        {
                           if(eval("\x01") != 932)
                           {
                              if(eval("\x01") == 10)
                              {
                                 ...
                                 eval("{invalid_utf8:164}W")[" {invalid_utf8:215}\t{invalid_utf8:152}"] = eval("{invalid_utf8:164}W")[§§constant(2)];
                                 eval("{invalid_utf8:164}W")[§§constant(2)] = eval("{invalid_utf8:164}W")[§§constant(3)];
                                 eval("{invalid_utf8:164}W")[§§constant(3)] = §§constant(4);
                                 eval("{invalid_utf8:164}W")[§§constant(5)][§§constant(6)]();
                                 var §§constant(7) = §§constant(8);
                                 eval(§§constant(9))[§§constant(10)][§§constant(11)][§§constant(12)](eval(§§constant(7)),26,52);
                                 eval("{invalid_utf8:164}W")[§§constant(13)] += 3;
                                 eval("{invalid_utf8:164}W")[§§constant(14)] = 0;
                                 eval("{invalid_utf8:164}W")[§§constant(15)] = 0;
                                 eval("{invalid_utf8:164}W")[§§constant(16)] = 0;
                                 eval("{invalid_utf8:164}W")[§§constant(17)][§§constant(18)](§§constant(17));
                                 eval("{invalid_utf8:164}W")[§§constant(19)][§§constant(18)](§§constant(19));
                                 break loop0;
                              }
                              addr531:
                              if(eval("\x01") == 496)
                        ...
                        while(true)
                        {
                           ...
                           else
                           {
                              if(eval("\x01") == 22)
                              {
                                 ...
                                 if(eval(§§pop())[§§constant(3)] == 1)
                                 {
                                    eval(§§constant(2))[§§constant(3)] = 0;
                                    eval(§§constant(2))[§§constant(4)][§§constant(5)]();
                                    eval(§§constant(2))[§§constant(6)][§§constant(7)][§§constant(8)][§§constant(9)][§§constant(10)][§§constant(11)][§§constant(5)]();
                                    eval(§§constant(2))[§§constant(6)][§§constant(7)][§§constant(8)][§§constant(9)][§§constant(10)][§§constant(12)][§§constant(5)]();
                              ...
                              {
                                 set("\x01",eval("\x01") - 948);
                                 if(§§pop())
                                 {
                                    set("\x01",eval("\x01") + 330);
                                 }
                              }
                              else if(eval("\x01") == 352)
                              {
