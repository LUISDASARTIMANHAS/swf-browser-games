         ...
         else
         {
            if(eval("\x01") != 100)
            {
               if(eval("\x01") == 182)
               {
                  ...
                  eval("{invalid_utf8:231}A{invalid_utf8:143}")["{invalid_utf8:214}{invalid_utf8:227}"]["{invalid_utf8:228}B{invalid_utf8:157}{invalid_utf8:251}"] += eval("${invalid_utf8:238}{invalid_utf8:172}");
                  break loop0;
               }
               if(eval("\x01") == 344)
               {
