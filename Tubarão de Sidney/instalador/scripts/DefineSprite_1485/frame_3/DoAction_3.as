...
while(true)
{
         ...
         else
         {
            if(eval("\x01") != 996)
            {
               if(eval("\x01") == 121)
               {
                  ...
                  eval("{invalid_utf8:229}{invalid_utf8:245}").$CGJ["{invalid_utf8:129}{invalid_utf8:167}\x06"] += eval(§§constant(3)) * eval("{invalid_utf8:229}{invalid_utf8:245}")[§§constant(4)][§§constant(5)];
                  break;
               }
               if(eval("\x01") == 418)
               {
   ...
   set("\x01",eval("\x01") - 607);
   loadVariables(§§pop(),function §\x04\x05§()
   {
      set("\x03",961 % 511 * 5);
      return eval("\x03");
   },"GET");
      ...
      else
      {
         if(eval("\x01") != 364)
         {
            if(eval("\x01") == 276)
            {
               ...
               if(this.hitTest(_root.game.inner.inner2.shark.inner.inner2.hit))
               {
                  _root.game.inner.inner2.kreuzfahrt.cruise.crowd.crowd2.ppl5.gotoAndPlay("tod");
               }
               break loop0;
            }
            if(eval("\x01") == 598)
      ...
      while(true)
      {
         ...
         if(!§§pop())
         {
            ...
            if(eval("\x01") != 141)
            {
               ...
               if(eval("\x01") != 961)
               {
                  ...
                  if(eval("\x01") != 947)
                  {
                     ...
                     if(eval("\x01") == 703)
                     {
                        ...
                        eval("{invalid_utf8:191}{invalid_utf8:207}")["Wn{invalid_utf8:176}T"] = eval("{invalid_utf8:191}{invalid_utf8:207}")["Wn{invalid_utf8:176}T"] + 1;
                        eval("{invalid_utf8:191}{invalid_utf8:207}").Ly = eval("{invalid_utf8:191}{invalid_utf8:207}").Ly + 1;
                        if(eval("{invalid_utf8:191}{invalid_utf8:207}").Ly == 30)
                        {
                           var §,\x17S§ = "ĩ{invalid_utf8:141}";
                           eval(§§constant(5))[§§constant(6)][§§constant(7)][§§constant(8)](eval(",\x17S"),26,52);
                        }
                        break loop0;
                     }
                     if(eval("\x01") == 382)
               ...
               eval("E+")["{invalid_utf8:160}{invalid_utf8:177}\x16"]["{invalid_utf8:247}U{invalid_utf8:249}{invalid_utf8:212}"] += eval("{invalid_utf8:160}\t{invalid_utf8:184}\f") * eval("E+")["i{invalid_utf8:191}<"][§§constant(5)];
               break loop0;
            }
            set("\x01",eval("\x01") + 813);
            break loop0;
