...
while(true)
{
   ...
   while(true)
   {
      ...
      {
         set("\x01",eval("\x01") - 39);
         eval("{invalid_utf8:172}{invalid_utf8:225}")["��{invalid_utf8:137}{invalid_utf8:131}"]["{invalid_utf8:188}*R{invalid_utf8:216}"] += eval(§§constant(3)) * eval("{invalid_utf8:172}{invalid_utf8:225}")[§§constant(4)][§§constant(5)];
         break loop0;
      }
      if(eval("\x01") == 2)
      {
            ...
            else
            {
               ...
               else
               {
                  if(eval("\x01") == 431)
                  {
                     ...
                     if(eval("\"{invalid_utf8:201}{invalid_utf8:194}{invalid_utf8:149}")["\x11"](40))
                     {
                        if(eval(§§constant(2))[§§constant(3)] == 1)
                        {
         ...
         while(true)
         {
            ...
            else
            {
               if(eval("\x01") == 748)
               {
                  ...
                  eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}").Um = eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}")["{invalid_utf8:134}?{invalid_utf8:177}{invalid_utf8:137}"];
                  eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}")["{invalid_utf8:134}?{invalid_utf8:177}{invalid_utf8:137}"] = eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}")["9~"];
                  eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}")["9~"] = §§constant(4);
                  eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}")[§§constant(5)][§§constant(6)]();
                  eval("^{invalid_utf8:226}{invalid_utf8:199}{invalid_utf8:77}")[§§constant(7)] += 1;
                  break loop0;
               }
               if(eval("\x01") == 581)
               {
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           if(eval("\x01") == 930)
                           {
                              ...
                              _root.text2.text1.text0["SHARK CRUSHED BROADCAST HELI, 2 KILLED"].text1.stopuhr.play();
                              break loop0;
                           }
                           if(eval("\x01") == 783)
                           {
