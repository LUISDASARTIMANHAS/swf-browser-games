               ...
               else
               {
                  if(eval("\x01") != 514)
                  {
                     if(eval("\x01") == 436)
                     {
                        ...
                        eval("{invalid_utf8:170}{invalid_utf8:145}{invalid_utf8:148}{invalid_utf8:255}")["{invalid_utf8:231}5"]._E = eval("{invalid_utf8:170}{invalid_utf8:145}{invalid_utf8:148}{invalid_utf8:255}")["{invalid_utf8:201}{invalid_utf8:204}"];
                        eval("{invalid_utf8:170}{invalid_utf8:145}{invalid_utf8:148}{invalid_utf8:255}")["{invalid_utf8:231}5"].tV = eval("{invalid_utf8:170}{invalid_utf8:145}{invalid_utf8:148}{invalid_utf8:255}")[§§constant(5)];
                        break loop0;
                     }
                     if(eval("\x01") == 170)
                     {
