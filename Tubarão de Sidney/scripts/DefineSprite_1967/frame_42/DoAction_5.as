...
while(true)
{
   ...
   else
   {
      if(eval("\x01") == 45)
      {
                  ...
                  while(true)
                  {
                     ...
                     else
                     {
                                    ...
                                    else
                                    {
                                       ...
                                       else
                                       {
                                          if(eval("\x01") == 135)
                                          {
                                             ...
                                             eval("r{invalid_utf8:186}{invalid_utf8:203}O")["{invalid_utf8:155}{invalid_utf8:241}"][§§constant(2)] -= eval(§§constant(3));
                                             eval("r{invalid_utf8:186}{invalid_utf8:203}O")["{invalid_utf8:155}{invalid_utf8:241}"][§§constant(4)] -= eval(§§constant(3));
                                             break loop0;
                                          }
                                          if(eval("\x01") == 787)
                                          {
                        ...
                        if(eval("\x01") == 138)
                        {
                           set("\x01",eval("\x01") + 528);
                           nextFrame();
                           eval("F#{invalid_utf8:146}6")["{invalid_utf8:212}C"]["1\\"] -= eval(§§constant(3));
                           eval("F#{invalid_utf8:146}6")["{invalid_utf8:212}C"][§§constant(4)] -= eval(§§constant(3));
                           break loop0;
                        }
                        if(eval("\x01") == 535)
                        {
                        ...
                        else
                        {
                           ...
                           else
                           {
                              if(eval("\x01") == 802)
                              {
                                 ...
                                 eval("\x12{invalid_utf8:227}{invalid_utf8:138}K")["{invalid_utf8:169}{invalid_utf8:182}\x13\x17"]["v\x0f{invalid_utf8:142}{invalid_utf8:186}"] -= eval(§§constant(3));
                                 break loop0;
                              }
                              if(eval("\x01") == 552)
                              {
                  ...
                  else
                  {
                     ...
                     else
                     {
                        if(eval("\x01") == 51)
                        {
                           ...
                           if(eval("{invalid_utf8:146}f") >= 1)
                           {
                              §{invalid_utf8:146}f§--;
                              eval("\x03{invalid_utf8:204}C")["a{invalid_utf8:201}{invalid_utf8:244}"]["{invalid_utf8:132}{invalid_utf8:225}"] += eval("n{invalid_utf8:243}}");
                           }
                           break loop0;
                        }
                        if(eval("\x01") != 720)
                     ...
                     while(true)
                     {
                        ...
                        else
                        {
                           if(eval("\x01") == 291)
                           {
                              ...
                              if(eval("{invalid_utf8:146}f")["a{invalid_utf8:201}{invalid_utf8:244}"]["{invalid_utf8:132}{invalid_utf8:225}"]["n{invalid_utf8:243}}"][§§constant(5)][§§constant(6)][§§constant(7)][§§constant(8)](eval("{invalid_utf8:146}f")["\x03{invalid_utf8:204}C"]))
                              {
                                 eval("{invalid_utf8:146}f")[§§constant(9)][§§constant(10)] = 1;
                                 set(§§constant(11),eval(§§constant(11)) + 1);
                                 eval("{invalid_utf8:146}f")["a{invalid_utf8:201}{invalid_utf8:244}"][§§constant(12)] -= eval(§§constant(13));
                              }
                              break loop0;
                           }
                           if(eval("\x01") == 444)
         ...
         set("\x01",eval("\x01") - 31);
         if(eval("C{invalid_utf8:247}{invalid_utf8:134}{invalid_utf8:250}") >= 1)
         {
            §C{invalid_utf8:247}{invalid_utf8:134}{invalid_utf8:250}§--;
            eval("{invalid_utf8:230}{invalid_utf8:218}")[§§constant(2)][§§constant(3)] += eval(§§constant(4));
         }
         break;
      }
      if(eval("\x01") == 550)
      ...
      else
      {
         if(eval("\x01") == 139)
         {
            set("\x01",eval("\x01") + 851);
            eval("E{invalid_utf8:174}q")["#{invalid_utf8:143}"]["{invalid_utf8:130}t{invalid_utf8:179}"] += eval(§§constant(3));
            eval("E{invalid_utf8:174}q")["#{invalid_utf8:143}"][§§constant(4)] += eval(§§constant(3));
            break;
         }
         if(eval("\x01") == 850)
         {
