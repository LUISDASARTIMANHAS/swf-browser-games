            ...
            else
            {
               if(eval("\x01") != 534)
               {
                  if(eval("\x01") == 54)
                  {
                     ...
                     eval("{invalid_utf8:130}XY")["[AG{invalid_utf8:243}"][§§constant(2)] -= eval(§§constant(3));
                     eval("{invalid_utf8:130}XY")["[AG{invalid_utf8:243}"][§§constant(4)] -= eval(§§constant(3));
                     break;
                  }
                  if(eval("\x01") == 504)
                  {
            ...
            if(eval("\x01") != 405)
            {
               ...
               if(eval("\x01") != 4)
               {
                  ...
                  if(eval("\x01") != 212)
                  {
                     ...
                     if(eval("\x01") == 849)
                     {
                        ...
                        eval("\x1d{invalid_utf8:188}{invalid_utf8:129}{invalid_utf8:218}")["X\x12>B"]["l{invalid_utf8:225}"] += eval("{invalid_utf8:190}f\x13");
                        break loop0;
                     }
                     if(eval("\x01") == 188)
                     {
               ...
               if(eval(§§pop()) != 547)
               {
                  ...
                  if(eval("\x01") == 435)
                  {
                     ...
                     eval("{invalid_utf8:130}{invalid_utf8:173}\b")["{invalid_utf8:178}5"][§§constant(2)][§§constant(3)][§§constant(2)][§§constant(4)][§§constant(5)](2);
                     eval("{invalid_utf8:130}{invalid_utf8:173}\b")["{invalid_utf8:178}5"][§§constant(2)][§§constant(3)][§§constant(2)][§§constant(6)][§§constant(5)](2);
                     eval("{invalid_utf8:130}{invalid_utf8:173}\b")[§§constant(7)] = 1;
                     break loop0;
                  }
                  if(eval("\x01") == 307)
                  {
