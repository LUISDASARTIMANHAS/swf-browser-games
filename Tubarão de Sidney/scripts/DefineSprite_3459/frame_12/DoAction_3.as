                              ...
                              while(true)
                              {
                                 while(true)
                                 {
                                    ...
                                    else
                                    {
                                       if(eval("\x01") == 126)
                                       {
                                          set("\x01",eval("\x01") + 789);
                                          eval("{invalid_utf8:151}\x1e\'^")["{invalid_utf8:138}{invalid_utf8:254}A{invalid_utf8:189}"]["\x02NVw"] += eval("0{invalid_utf8:186}r{invalid_utf8:253}");
                                          break loop0;
                                       }
                                       if(eval("\x01") == 906)
                                       {
                                       ...
                                       else
                                       {
                                          if(eval("\x01") == 322)
                                          {
                                             ...
                                             eval("tk{invalid_utf8:232}m")["{invalid_utf8:182}{invalid_utf8:249}*{invalid_utf8:145}"]["{invalid_utf8:141}#K"] += eval("V\'{invalid_utf8:151}");
                                             break loop0;
                                          }
                                          if(eval("\x01") == 213)
                                          {
                        ...
                        else
                        {
                           ...
                           else
                           {
                              if(eval("\x01") == 23)
                              {
                                 ...
                                 _root.game._xscale -= skalieren;
                                 _root.game._yscale -= skalieren;
                                 break loop0;
                              }
                              if(eval("\x01") == 831)
                              {
