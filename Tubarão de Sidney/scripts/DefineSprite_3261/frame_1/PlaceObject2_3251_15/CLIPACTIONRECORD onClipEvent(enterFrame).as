      ...
      if(eval("\x01") != 726)
      {
         ...
         else
         {
            if(eval("\x01") == 38)
            {
               ...
               if(eval(§§constant(5))[§§constant(6)](eval("{invalid_utf8:191}Y")["{invalid_utf8:201}!"][§§constant(2)][§§constant(3)][§§constant(4)]))
               {
                  if(eval("{invalid_utf8:191}Y")[§§constant(7)] == 0)
                  {
                     eval("{invalid_utf8:191}Y")["{invalid_utf8:201}!"][§§constant(2)][§§constant(3)][§§constant(8)][§§constant(9)][§§constant(2)][§§constant(10)]();
                  }
               }
               break;
            }
            ...
            if(eval("\x01") != 111)
            {
               ...
               while(true)
               {
                  ...
                  while(eval("\x01") != 6)
                  {
                     ...
                     else if(eval("\x01") == 580)
                     {
                        set("\x01",eval("\x01") - 463);
                     }
                     else if(eval("\x01") == 403)
                     {
