package com.mindgame.tweener.easing.equations
{
   ...
   public final class ElasticEaseIn implements IEasing
   {
      ...
      public function ElasticEaseIn(param1:Number, param2:Number)
      {
         super();
         this.a = param1;
         this.p = param2;
      ...
      public function calculate(param1:Number) : Number
      {
         ...
         return -(this.a * Math.pow(2,10 * (param1 = param1 - 1)) * Math.sin((param1 - _loc2_) * (2 * Math.PI) / this.p));
      }
