package org.flixel.system.debug
{
   ...
   public class Watch extends FlxWindow
   {
      ...
      override public function destroy() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:uint = uint(this._watching.length);
         while(_loc1_ < _loc2_)
         {
      ...
      public function add(param1:Object, param2:String, param3:String = null) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:uint = uint(this._watching.length);
         while(_loc5_ < _loc6_)
         {
      ...
      public function remove(param1:Object, param2:String = null) : void
      {
         ...
         _loc3_ = null;
         _loc4_ = 0;
         var _loc5_:uint = uint(this._watching.length);
         while(_loc4_ < _loc5_)
         {
      ...
      public function removeAll() : void
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:uint = uint(this._watching.length);
         while(_loc2_ < _loc3_)
         {
