package com.greensock.plugins
{
   ...
   public class FilterPlugin extends TweenPlugin
   {
      ...
      protected function initFilter(param1:Object, param2:BitmapFilter, param3:Array) : void
      {
         ...
         while(_loc6_--)
         {
            §§push((_loc5_ = String(param3[_loc6_])) in param1);
            if((_loc5_ = String(param3[_loc6_])) in param1)
            {
               §§pop();
               while(true)
               {
            ...
            while(true)
            {
               if(§§pop())
               {
                  §§push(_loc5_ == "color" || _loc5_ == "highlightColor");
                  if(_loc5_ == "color" || _loc5_ == "highlightColor")
                  {
                     break;
                  }
                  §§pop();
