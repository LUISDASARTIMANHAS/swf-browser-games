package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="TenantBoutiqueA")]
   public dynamic class TenantBoutiqueA extends MovieClip
   {
      ...
      public const PRICE:Array = [120,180,240];
      
      public var visitorList:Array;
      
      public const UPGRADE_COST:Array = [5000,8000];
      ...
      public function Visited(param1:MovieClip) : Boolean
      {
         ...
         return param1.worldX > this.worldX + this.door.x + this.door.width - 10 && param1.worldX < this.worldX + this.door.x + this.door.width;
      }
      ...
      public function testBuildRelation() : Number
      {
         ...
         while(_loc3_ < _loc1_.tenantList.length)
         {
            if((_loc4_ = _loc1_.tenantList[_loc3_]) != this && _loc4_.ground == ground)
            {
               ...
               {
                  if(_loc4_ is TenantBoutiqueA || _loc4_ is TenantBoutiqueB || _loc4_ is TenantJewelry)
                  {
                     _loc2_ += 1;
                  }
      ...
      public function ExitShop(param1:MovieClip) : void
      {
         ...
         if(door.currentFrame >= 10 && door.currentFrame - _loc2_.gameSpeed < 10)
         {
            ...
            if((_loc4_ = Math.floor(_loc3_) - 2) < 1)
            {
               _loc4_ = 1;
            }
            ...
            income += _loc5_;
            _loc2_.addCashUpdate(_loc5_,this.worldX + this.door.x + this.door.width,this.worldY + this.door.y,true);
            param1.alpha = 1;
      ...
      public function restoreRelation() : void
      {
         ...
         while(_loc2_ < _loc1_.tenantList.length)
         {
            ...
            if(_loc3_ != this && _loc3_.ground == ground)
            {
               ...
               {
                  if(_loc3_ is TenantBoutiqueA || _loc3_ is TenantBoutiqueB || _loc3_ is TenantJewelry)
                  {
                     --_loc1_.popularity;
                  }
