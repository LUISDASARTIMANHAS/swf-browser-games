package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="CrewCleaningServicelv1")]
   public dynamic class CrewCleaningServicelv1 extends MovieClip
   {
      ...
      public const nextUpgrade:* = CrewCleaningServicelv2;
      ...
      public function scanTarget() : MovieClip
      {
         ...
         _loc1_ = null;
         _loc2_ = 0;
         while(_loc2_ < myParent.dirtyParent.numChildren)
         {
            _loc3_ = myParent.dirtyParent.getChildAt(_loc2_);
            if(_loc3_.bundle)
            {
               if(_loc1_ == null)
               {
               ...
               else if(shiftFloor < 0 || myParent.floorList[shiftFloor] == _loc3_.ground)
               {
                  if(_loc3_.ground == floorPos)
                  {
         ...
         if(_loc1_ != null)
         {
            ...
            else if(!_loc1_.worker.isCleaning)
            {
               if(_loc1_.ground == floorPos)
               {
         ...
         while(sp < myParent.gameSpeed)
         {
            ...
            if(destination != null && !goHome)
            {
               ...
               else if(!isCleaning)
               {
                  ...
                  else if(worldX > destination.worldX)
                  {
                     dx = -speedX;
                  }
                  else if(worldX < destination.worldX)
