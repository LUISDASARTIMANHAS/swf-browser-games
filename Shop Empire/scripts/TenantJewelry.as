package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="TenantJewelry")]
   public dynamic class TenantJewelry extends MovieClip
   {
      ...
      public const PRICE:Array = [300,400,500];
      
      public var visitorList:Array;
      
      public const UPGRADE_COST:Array = [16500,18000];
      ...
      public function testBuildRelation() : Number
      {
         ...
         while(_loc3_ < _loc1_.tenantList.length)
         {
            if((_loc4_ = _loc1_.tenantList[_loc3_]) != this && _loc4_.ground == ground)
            {
               ...
               {
                  if(_loc4_ is TenantBoutiqueA || _loc4_ is TenantBoutiqueB)
                  {
                     _loc2_ += 2;
                  }
      ...
      public function ExitShop(param1:MovieClip) : void
      {
         ...
         if(door.currentFrame >= 10 && door.currentFrame - _loc2_.gameSpeed < 10)
         {
            _loc3_ = Math.round(param1.mood / 20);
      ...
      public function restoreRelation() : void
      {
         ...
         while(_loc2_ < _loc1_.tenantList.length)
         {
            ...
            if(_loc3_ != this && _loc3_.ground == ground)
            {
               ...
               {
                  if(_loc3_ is TenantBoutiqueA || _loc3_ is TenantBoutiqueB)
                  {
                     _loc1_.popularity -= 2;
                  }
                  else if(_loc3_ is TenantSalon)
                  {
                     --_loc1_.popularity;
                  }
               }
