package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="TenantDrugStore")]
   public dynamic class TenantDrugStore extends MovieClip
   {
      ...
      public const PRICE:Array = [20,40,60];
      
      public var visitorList:Array;
      
      public const UPGRADE_COST:Array = [2500,3000];
      ...
      public function Visited(param1:MovieClip) : Boolean
      {
         ...
         return param1.worldX > this.worldX + this.door.x + 20 && param1.worldX < this.worldX + this.door.x + this.door.width - 20;
      }
      ...
      public function ExitShop(param1:MovieClip) : void
      {
         ...
         if(door.currentFrame >= 10 && door.currentFrame - _loc2_.gameSpeed < 10)
         {
            _loc3_ = Math.round(param1.mood / 8);
