package PlazaMall_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="PlazaMall_fla.Game_536")]
   public dynamic class Game_536 extends MovieClip
   {
      ...
      public function crewUpdate(param1:Event) : void
      {
         ...
         {
            _loc2_.work.visible = _loc2_.relation.isAction;
            _loc2_.walk.visible = !_loc2_.relation.isAction && _loc2_.relation.dx != 0;
            _loc2_.stanby.visible = !_loc2_.relation.isAction && _loc2_.relation.dx == 0;
            _loc2_.pursue.visible = _loc2_.relation.banditTarget != null || head.banditTrigger != null;
            _loc2_.pursueSymbol.visible = _loc2_.relation.banditTarget != null || head.banditTrigger != null;
