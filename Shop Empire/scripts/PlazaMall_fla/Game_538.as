package PlazaMall_fla
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="PlazaMall_fla.Game_538")]
   public dynamic class Game_538 extends MovieClip
   {
      ...
      public function crewUpdate(param1:Event) : void
      {
         ...
         {
            _loc2_.work.visible = _loc2_.relation.isCleaning;
            _loc2_.walk.visible = !_loc2_.relation.isCleaning && _loc2_.relation.dx != 0;
            _loc2_.stanby.visible = !_loc2_.relation.isCleaning && _loc2_.relation.dx == 0;
