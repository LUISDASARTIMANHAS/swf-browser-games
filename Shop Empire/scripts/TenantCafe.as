package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="TenantCafe")]
   public dynamic class TenantCafe extends MovieClip
   {
      ...
      public const PRICE:Array = [160,180,200];
      ...
      public function Visited(param1:MovieClip) : Boolean
      {
         ...
         if(!isClose)
         {
            ...
            _loc2_ = Math.random() * 10 < 0.5;
         }
         else
         {
            _loc2_ = param1.worldX > this.worldX + this.door.x + this.door.width / 2 - 10 && param1.worldX < this.worldX + this.door.x + this.door.width / 2 + 10;
         }
         return _loc2_;
      }
      ...
      public function testBuildRelation() : Number
      {
         ...
         while(_loc3_ < _loc1_.tenantList.length)
         {
            if((_loc4_ = _loc1_.tenantList[_loc3_]) != this && _loc4_.ground == ground)
            {
               ...
               {
                  if(_loc4_ is TenantSupermarket || _loc4_ is TenantIceCream)
                  {
                     _loc2_ += 2;
                  }
      ...
      public function restoreRelation() : void
      {
         ...
         while(_loc2_ < _loc1_.tenantList.length)
         {
            ...
            if(_loc3_ != this && _loc3_.ground == ground)
            {
               ...
               {
                  if(_loc3_ is TenantSupermarket || _loc3_ is TenantIceCream)
                  {
                     _loc1_.popularity -= 2;
                  }
