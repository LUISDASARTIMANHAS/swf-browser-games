package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="TenantToyStore")]
   public dynamic class TenantToyStore extends MovieClip
   {
      ...
      public const PRICE:Array = [120,150,200];
      ...
      public function testBuildRelation() : Number
      {
         ...
         while(_loc3_ < _loc1_.tenantList.length)
         {
            if((_loc4_ = _loc1_.tenantList[_loc3_]) != this && _loc4_.ground == ground)
            {
               ...
               {
                  if(_loc4_ is TenantBookStore)
                  {
                     _loc2_ += 1;
                  }
                  else if(_loc4_ is TenantGameCenter)
                  {
                     _loc2_ += 2;
                  }
               }
      ...
      public function restoreRelation() : void
      {
         ...
         while(_loc2_ < _loc1_.tenantList.length)
         {
            ...
            if(_loc3_ != this && _loc3_.ground == ground)
            {
               ...
               {
                  if(_loc3_ is TenantBookStore)
                  {
                     --_loc1_.popularity;
                  }
                  else if(_loc3_ is TenantGameCenter)
                  {
                     _loc1_.popularity -= 2;
                  }
               }
