package mochicrypt.as3
{
   ...
   public class MochiAd
   {
      ...
      public static function _cleanup(param1:Object) : void
      {
         ...
         idx = Number(DisplayObjectContainer(mc).numChildren);
         while(idx > 0)
         {
            idx--;
      ...
      public static function load(param1:Object) : MovieClip
      {
         ...
         lc.client = mc;
         name = String(["",Math.floor(new Date().getTime()),Math.floor(Math.random() * 999999)].join("_"));
      ...
      public static function _getRes(param1:Object, param2:Object) : Array
      {
         ...
         if(typeof param1.res != "undefined")
         {
            ...
            _loc4_ = Number(parseFloat(_loc6_[0]));
            _loc5_ = Number(parseFloat(_loc6_[1]));
         }
         else
         {
      ...
      public static function showPreGameAd(param1:Object) : void
      {
         ...
         complete = false;
         unloaded = false;
         progress = Number(Math.min(1,options.progress_override(clip)));
         ...
         chk["onEnterFrame"] = function():void
         {
            ...
            var _loc7_:Number;
            if((_loc7_ = Number(Math.min(1,options.progress_override(_loc1_)))) == 1)
            {
               complete = true;
            }
            if(complete)
            {
               _loc5_ = _loc6_ = Number(Math.max(1,_loc6_));
            }
            ...
            var _loc11_:Number = Number(Math.min(100,Math.min(_loc8_ || 0,_loc9_)));
            _loc11_ = Number(Math.max(this.last_pcnt,_loc11_));
